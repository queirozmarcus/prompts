# CLAUDE.md – Docker & Docker Compose (Advanced Skill)

## Scope

This file defines how Claude Code should behave when working with **Docker and Docker Compose**, with an **advanced, production-oriented mindset**.
