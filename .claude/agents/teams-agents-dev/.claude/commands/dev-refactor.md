---
name: dev-refactor
description: "Refatoração segura com preservação de comportamento. Orquestra Refactoring Engineer e Code Reviewer."
argument-hint: "[classe-ou-módulo]"
---
...
Use o sub-agente **refactoring-engineer** para:
...
4. Instrução: "Use `/qa-review` para verificar que testes continuam passando"
