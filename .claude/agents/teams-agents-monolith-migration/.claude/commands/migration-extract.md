---
name: migration-extract
description: "Fase 3 — Extrair bounded context como microsserviço. Orquestra Backend Engineer, Data Engineer, QA Engineer, Platform Engineer e Security Engineer."
argument-hint: "[nome-do-contexto]"
---
...
Use o sub-agente **domain-analyst** para:
...
Use o sub-agente **backend-engineer** para:
...
Use o sub-agente **data-engineer** para:
...
Use o sub-agente **platform-engineer** para:
...
Use o sub-agente **qa-engineer** para:
...
Use o sub-agente **security-engineer** para:
