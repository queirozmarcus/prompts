...
description: "Provisionar infra completa para novo serviço. Orquestra IaC, CI/CD, K8s, Observability e Security."
...
Instrução para o dev: "Use `/dev-bootstrap {serviço}` para gerar o código do serviço."
