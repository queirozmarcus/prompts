...
description: |
  Cloud cost optimization specialist. Use for:
  - AWS cost analysis (Cost Explorer, CUR, Budgets, anomaly detection)
  - Rightsizing (EC2, RDS, EKS, ECS Fargate, ElastiCache)
  - Savings Plans vs Reserved Instances recommendations
  - Waste identification (idle ELBs, unattached EBS, orphaned snapshots)
  - NAT Gateway and data transfer cost reduction
  - Kubecost for K8s cost attribution
