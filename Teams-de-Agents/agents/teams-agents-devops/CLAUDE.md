...
|--------|---------------|
| **DevOps Lead** | Estratégia de plataforma, padrões, decisões de infra, FinOps |
| **IaC Engineer** | Terraform/OpenTofu, módulos, state, multi-cloud provisioning |
| **CI/CD Engineer** | Pipelines, quality gates, build, deploy, GitOps (ArgoCD/Flux) |
...
| **Service Mesh Engineer** | Istio/Linkerd, mTLS, traffic management, canary, observability |
| **SRE Engineer** | Incident response, postmortems, chaos engineering, DR, capacity |
