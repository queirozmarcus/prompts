...
**Integração com QA Team:** Esta equipe é complementar ao pack de QA (`qa-team-agents`). Os agentes de dev implementam — os agentes de QA validam. Use `/qa-generate` após implementar, `/qa-audit` antes de release.
...
| **DBA** | Schema, queries, migrations, indexação, performance SQL | Modelagem de dados, Flyway, queries complexas, tuning |
