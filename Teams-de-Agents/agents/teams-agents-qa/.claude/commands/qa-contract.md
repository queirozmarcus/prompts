---
name: qa-contract
description: "Criar ou validar contract tests para um servico. Orquestra Contract Test Engineer."
argument-hint: "[servico-ou-api]"
---
...
Use o sub-agente **contract-test-engineer** para:
...
- Configurar consumer-side verification para servicos dependentes
...
3. Instrucoes para rodar: `./mvnw test -Dtest="*ContractTest"`
