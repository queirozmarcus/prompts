# CLAUDE.md – Docker Security (Advanced Skill)

## Scope

This file defines how Claude Code should behave when dealing with **Docker container security**, image hardening, and runtime safety.
