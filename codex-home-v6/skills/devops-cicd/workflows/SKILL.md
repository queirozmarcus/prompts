...
- **Automate what repeats** — if a workflow runs >3 times, it should be a workflow or playbook
...
- Reference relevant workflows when available (e.g., `/dev-feature`, `/qa-generate`)
