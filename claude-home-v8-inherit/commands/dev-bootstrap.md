---
name: dev-bootstrap
description: "Bootstrap de microsserviço novo com estrutura completa. Orquestra Architect, Backend Dev, DBA, API Designer e DevOps Engineer."
...
Use o sub-agente **backend-dev** para criar:
...
Use o sub-agente **devops-engineer** para:
...
5. Instrução: "Use `/qa-audit` para verificar qualidade" (integração com QA team)
