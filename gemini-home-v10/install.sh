...
echo "═══════════════════════════════════════"
echo "  Instalação do Ecossistema Gemini CLI v10"
...
# Agents (flat — como Gemini CLI espera conceitualmente)
...
echo "✓ $(find "$TARGET/skills" -name 'CLAUDE.md' | wc -l) skills instaladas (nota: arquivos internos ainda podem se chamar CLAUDE.md por compatibilidade de skill-helper)"
...
echo ""
echo "Para começar:"
echo "  gemini --agent marcus"
echo ""
echo "Para verificar:"
echo "  ls ~/.gemini/agents/*.md | wc -l    # deve ser 37"
