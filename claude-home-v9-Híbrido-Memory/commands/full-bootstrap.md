---
name: full-bootstrap
description: "Bootstrap completo de microsserviço: código + testes + infra + pipeline + observabilidade. Orquestra Dev, QA e DevOps packs em sequência."
argument-hint: "[nome-do-serviço] [cloud: aws|gcp|azure]"
---
...
Use o sub-agente **integration-test-engineer** para:
...
Use o sub-agente **devops-engineer** (ou **cicd-engineer** se disponível) para:
