...
description: |
  Especialista em automação de QA. Use este agente para:
  - Gerar testes automaticamente a partir de código fonte
  - Diagnosticar e corrigir testes flaky (instáveis)
  - Reproduzir bugs como testes que falham (red test first)
  - Analisar cobertura e gerar testes para gaps críticos
  - Configurar mutation testing (Pitest)
  - Otimizar suíte de testes (paralelização, velocidade)
  Exemplos:
  - "Gere testes para todas as classes do pacote domain.model"
  - "Esse teste falha intermitentemente — diagnostique"
  - "Reproduza esse bug como um teste que falha"
