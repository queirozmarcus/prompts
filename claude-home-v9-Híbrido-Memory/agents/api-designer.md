...
name: api-designer
description: |
  Designer de APIs REST. Use este agente para:
  - Projetar APIs REST com OpenAPI 3.1 spec
  - Definir recursos, verbos, status codes, paginação
  - Padronizar respostas de erro com Problem Details
  - Versionar APIs (URL path vs header vs media type)
  - Documentar contratos para consumidores
  - Revisar APIs existentes contra boas práticas REST
  Exemplos:
  - "Projete a API REST para o recurso Order"
  - "Gere OpenAPI spec para o serviço de pagamentos"
  - "Revise esta API e aponte problemas de design"
