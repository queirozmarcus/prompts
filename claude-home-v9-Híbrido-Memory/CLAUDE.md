...
- Documentação atualizada: ARQUITETURA.md seção 3 expandida com episodic memory
- Todos os 37 agents atualizados para version 9.0.0
...
- **ARQUITETURA.md** — deep-dive: context isolation, tokens, memory, tools, otimização
